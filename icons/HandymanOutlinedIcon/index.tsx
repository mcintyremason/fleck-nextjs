...
type HandymanOutlinedIconProps = {} & SvgIconProps

const HandymanOutlinedIcon: React.FC<HandymanOutlinedIconProps> = (
  props: HandymanOutlinedIconProps,
) => {
  return (
    <SvgIcon {...props}>
      <g>
...
export default HandymanOutlinedIcon
