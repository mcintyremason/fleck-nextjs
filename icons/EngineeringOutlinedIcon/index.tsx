...
type EngineerinOutlinedIconProps = {} & SvgIconProps

const EngineerinOutlinedIcon: React.FC<EngineerinOutlinedIconProps> = (
  props: EngineerinOutlinedIconProps,
) => {
  return (
    <SvgIcon {...props}>
      <g>
...
export default EngineerinOutlinedIcon
