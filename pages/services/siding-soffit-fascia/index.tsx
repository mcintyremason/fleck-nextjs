                ...
                <Grid container justify="center" className={styles['siding-content']}>
                  <Grid item xs={12} sm={8} className={styles['siding-text-container']}>
                    <Grid container className={styles['siding-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['siding-text']}>
                          Aging and degraded siding can detract from your home's appeal and value.
                          If you're ready for a positive change, Fleck Roofing & Construction is the
                          company to call. Our experienced team will replace your existing siding
                          with a more modern product that looks fantastic. You'll be able to choose
                          from a range of siding options, including:
                        </Typography>
                      </Grid>
                      <Grid item xs={12}>
                        <ul>
                    ...
                    <Grid container className={styles['siding-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['siding-text']}>
                          Although it is installed to last for years, your siding may need to
                          replaced if you notice:
                        </Typography>
                      </Grid>
                      <Grid item xs={12}>
                        <ul>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['siding-text']}>
                          Please know that when we replace your siding, we'll take care of
                          everything, including the soffit and fascia work. To learn more and for a
                          free quote, please <Link href="/contact">contact us</Link>.
                        </Typography>
                      </Grid>
                    </Grid>
                  </Grid>
