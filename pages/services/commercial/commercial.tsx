              ...
              <Grid container justifyContent="center" className={styles['commercial-content']}>
                <Grid item xs={12} sm={8} className={styles['commercial-text-container']}>
                  <Grid container className={styles['commercial-text-group']}>
                    ...
                    <Grid item xs={12}>
                      <Typography className={styles['commercial-text']}>
                        If you're looking for a contractor you can trust to work on your commercial
                        building's roof, choose Fleck Roofing & Construction. Our locally and family
                        owned company has a proven track record of providing exceptional roofing
                        services that dates to 1988.
                      </Typography>
                    </Grid>
                    <Grid item xs={12}>
                      <Typography className={styles['commercial-text']}>
                  ...
                  <Grid container className={styles['commercial-text-group']}>
                    ...
                    <Grid item xs={12}>
                      <Typography className={styles['commercial-text']}>
                        ...
                        why it's important to have someone with the necessary skills to work on it.
                      </Typography>
                    </Grid>
                    <Grid item xs={12}>
                      <Typography className={styles['commercial-text']}>
                        ...
                        and costly problems. This regular maintenance is designed to save you money
                        in the long run.
                      </Typography>
                    </Grid>
                  </Grid>
