                    ...
                    <Grid container className={styles['emergency-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['emergency-text']}>
                          ...
                          Construction a call. Our responsive crew will get to your property
                          quickly, assess the damage, and make a recommendation on the best course
                          of action.
                        </Typography>
                      </Grid>
                    </Grid>
                    <Grid container className={styles['emergency-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['emergency-text']}>
                          ...
                          roof leak repair and beyond. For a free quote on any of our services,
                          please <Link href="/contact">contact us</Link> today.
                        </Typography>
                      </Grid>
                    </Grid>
                  </Grid>
                  ...
                  <Grid item xs={12} className={styles['emergency-review-container']}>
                    ...
                    >
                      ...
                      >
                        ...
                        to a flashing issue. The team was very professional in identifying the
                        problem and explaining to me how they fixed it!
                      </Typography>
