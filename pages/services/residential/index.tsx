                ...
                <Grid container justify="center" className={styles['residential-content']}>
                  <Grid item xs={12} sm={8} className={styles['residential-text-container']}>
                    ...
                    <Grid container className={styles['residential-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['residential-text']}>
                          If your roof is 15 to 20 years or older or in need of extensive repairs,
                          it may be time for a roof replacement. When you’re ready to make this wise
                    ...
                    <Grid container className={styles['residential-text-group']}>
                      ...
                      <Grid item xs={12}>
                        <Typography className={styles['residential-text']}>
                          ...
                          the demolition of your existing roof to the installation of the new roof.
